...
array set Maps { text "Set of maps, starting with an overall summary, followed by more-detailed maps"
    ...
    010 {"Cruise overview" "Viking Octantis cruise -- Days 6-24, Dec 20 - Jan 6"
        {<p>We had been warned that the itinerary was tentative, and that weather and sea ice could force changes. That certainly turned out to be true, but the captain and crew did a magnificent job of reacting, so that our first planned stop, at West Point Island in the Falklands, was the only one completely missed. All the others, from South Georgia on, were just rescheduled to visit an accessible site.</p>}} 
...
array set EasterIsland {text "Easter Island"
    ...
    155 {"Easter Bunny Island, Rabbit Newie" "Easter Bunny Island, Rabbit Newie" "Someone else did this one, which I came across on Easter Week"  }
}
